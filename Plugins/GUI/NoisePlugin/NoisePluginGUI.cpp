...
{
	NoisePlugin *p = (NoisePlugin *)plugin;
	if (!p) return 0;
	return new NoisePluginGUI(p->GetPluginInfo().Width,
...
SSM_EXPORT_GUI_CLASS(49, "NoisePluginGUI", "Noise", "Oscillators", CreatePluginUI)
